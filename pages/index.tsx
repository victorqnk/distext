  ...
  return (
    <div className='text-slate-500'>
      ...
      <div className="h-screen bg-white">
        <section className="w-full bg-blue-800 flex justify-center h-2/3">
          <div className="my-auto text-center">
            <p className='text-blue-500 text-7xl'>Trabajamos para</p>
            <p className='text-white text-7xl'>Uniformar a tu empresa</p>
            <div className="bg-blue-500 uppercase rounded-full w-48 my-10 block mx-auto p-3 cursor-pointer">
              <span className="text-lg text-white font-bold">saber más</span>
            </div>
      ...
      <section className="container mx-auto text-center mb-48">
        ...
        <p className='text-4xl w-2/3 mx-auto'>Somos una empresa mexicana dedicada a la fabricación de uniformes industriales, casuales, de seguridad, médicos y personalizados.</p>
      </section>

      <section className="container mx-auto flex gap-6 text-center mb-12">
        <div>
