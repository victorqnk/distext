  ...
  return (
    <div className='text-slate-500'>
      ...
      <div className="h-screen bg-white">
        <section className="w-full bg-blue-800 bg-hero-image bg-fixed bg-cover flex justify-center h-3/4">
          <div className="my-auto text-center">
            <p className='text-blue-500 text-7xl font-light'>Trabajamos para</p>
      ...
      <section className="container mx-auto text-center mb-48">
        ...
        <p className='text-4xl w-2/3 mx-auto font-light'>Somos una empresa mexicana dedicada a la fabricación de uniformes industriales, casuales, de seguridad, médicos y personalizados.</p>
      </section>
